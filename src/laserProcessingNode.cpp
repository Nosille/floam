...
void laser_processing(){
    while(1){
        if(!pointCloudBuf.empty()){
            ...
            std::string pointcloud_frame = (pointCloudBuf.front())->header.frame_id;
            pointCloudBuf.pop();
            mutex_lock.unlock();
            ...
            *pointcloud_filtered+=*pointcloud_surf;
            ...
            laserCloudFilteredMsg.header.frame_id = pointcloud_frame;
            ...
            edgePointsMsg.header.frame_id = pointcloud_frame;
            ...
            surfPointsMsg.header.frame_id = pointcloud_frame;
